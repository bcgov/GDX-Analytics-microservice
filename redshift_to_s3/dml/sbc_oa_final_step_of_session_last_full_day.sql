SELECT * FROM (
    -- based off of the explore https://analytics.gov.bc.ca/explore/snowplow_web_block/sbc_online_appointments?qid=h7xCJDWbC91weEUQstlvJv&origin_space=37&toggle=fil,vis
    ...
    SELECT
        ...
        sbc_online_appointments.latest_step AS "sbc_online_appointments.latest_step",
        ...
        DATEDIFF(''seconds'', sbc_online_appointments.min_timestamp,sbc_online_appointments.max_timestamp)  AS "sbc_online_appointments.duration"
