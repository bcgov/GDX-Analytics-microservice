SELECT * FROM (
-- based on the SQL runner: https://analytics.gov.bc.ca/sql/rz3ywqy5yxqpgk
  SELECT
      (DATE(page_views.page_view_start_time )) AS "page_views.page_view_start_date",
      page_views.os_family  AS "page_views.os_family",
