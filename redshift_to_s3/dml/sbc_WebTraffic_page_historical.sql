SELECT * FROM (
    -- based off the explore https://analytics.gov.bc.ca/explore/snowplow_web_block/page_views?qid=EE1Y4dP90iyhGYMtifCi7i&toggle=fil
    SELECT
