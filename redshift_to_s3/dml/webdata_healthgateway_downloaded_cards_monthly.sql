-- taken from the explore: https://analytics.gov.bc.ca/explore/snowplow_web_block/healthgateway_actions?qid=oh9bHwSYdGIf8q8fea8PRG&origin_space=37&toggle=fil,vis
SELECT * FROM (
    SELECT
