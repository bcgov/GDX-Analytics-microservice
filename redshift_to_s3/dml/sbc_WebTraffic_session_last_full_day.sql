SELECT * FROM (
    -- based on the explore https://analytics.gov.bc.ca/explore/snowplow_web_block/page_views?qid=cjev9yTJauYiAfLqPO3df3&origin_space=37&toggle=fil,pik
    SELECT
