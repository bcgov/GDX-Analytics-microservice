SELECT * FROM (
  -- based off of the explore https://analytics.gov.bc.ca/explore/snowplow_web_block/sbc_online_appointments_clicks?qid=8daE9wqfF3gUfy8RwmZHbm&origin_space=37&toggle=fil,pik,vis
  -- using the stable name PDT BM_snowplow_web_block_sbc_online_appointments_clicks
  SELECT
      sbc_online_appointments_clicks.timestamp AS "sbc_online_appointments_clicks.timestamp",
