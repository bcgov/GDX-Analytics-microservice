CREATE TABLE IF NOT EXISTS microservice.chatbot_newreports
 (
 ...
 DISTSTYLE EVEN;
 ALTER TABLE microservice.chatbot_newreports owner to microservice;
 GRANT SELECT ON microservice.chatbot_newreports TO "looker";
