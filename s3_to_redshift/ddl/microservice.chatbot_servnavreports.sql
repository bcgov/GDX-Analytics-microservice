CREATE TABLE IF NOT EXISTS microservice.chatbot_servnavreports
 (
 ...
 DISTSTYLE EVEN;
 ALTER TABLE microservice.chatbot_servnavreports owner to microservice;
 GRANT SELECT ON microservice.chatbot_servnavreports TO "looker";
